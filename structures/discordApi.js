...
module.exports.getBot = (id) => {
  return new Promise(function (resolve, reject) {
    let data = [];
    unirest.get(`https://discord.com/api/users/${id}`)
      .headers({
...
module.exports.addUser = async (opts) => {
  return await opts.client.guilds.cache.get(process.env.GUILD_ID).addMember(opts.userId, {accessToken: opts.accessToken, roles: ['793680728348164107']}).catch(() => {});
};
